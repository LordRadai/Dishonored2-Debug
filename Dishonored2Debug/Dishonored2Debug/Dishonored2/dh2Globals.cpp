...
uint32_t* g_consoleTextBufferSize = nullptr;
HWND* g_voidEngineConsoleEditHwnd = nullptr;
...
namespace DH2
{
	bool GetGlobalVariables()
	{
		...
		g_consoleTextBufferSize = (uint32_t*)(MODULE_ADDR + 0x3139350);
		g_voidEngineConsoleEditHwnd = (HWND*)(MODULE_ADDR + 0x3138e48);
