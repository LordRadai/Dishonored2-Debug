...
namespace csys
{
    ...
    CSYS_INLINE void System::RunCommand(const std::string &line)
    {
        ...
        // Log command.
        Log(csys::ItemType::kCommand) << line << csys::endl;
    ...
    CSYS_INLINE void System::RunScript(const std::string &script_name)
    {
        ...
        {
            m_ItemLog.log(kError) << "Script \"" << script_name << "\" not found" << csys::endl;
            return;
        }

        // About to run script.
        m_ItemLog.log(kInfo) << "Running \"" << script_name << "\"" << csys::endl;
    ...
    CSYS_INLINE void System::ParseCommandLine(const String &line)
    {
        ...
        if (command == m_Commands.end())
            Log(kError) << s_ErrorSetGetNotFound << endl;
            // Run the command
        else
        {
            // Get the arguments.
