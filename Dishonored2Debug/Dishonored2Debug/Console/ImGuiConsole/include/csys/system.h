...
namespace csys
{
    ...
    public:
         ...
         */
        ItemLog &Log(ItemType type = ItemType::kLog);
        ...
        void RegisterCommand(const String &name, const String &description, Fn function, Args... args)
        {
            ...
            {
                Log(kError) << "Empty command name given" << csys::endl;
                return;
            }
            ...
            auto help = [this, command_name]() {
                Log(kLog) << m_Commands[command_name]->Help() << csys::endl;
            };
